...
*************************
Set up:
PixPlantTrackerV1.zip should be extracted and opened via Android Studio
Within Android studio, create a 'Device' for the Emulator
Recommended: API 31+
Build Gradle files by clicking 'Sync Project with Gradle Files' at top right of Android Studio
Ensure 'App' is selected as well as your device in the top right of Android Studio
Click Green 'Play' button.  
This should launch the device (which may take a few minutes for the first launch) followed by the app on the device
*************************
